...
Colours.Text = Colour4.new(1.0, 1.0, 1.0)
Colours.TextDisabled = Colour4.new(0.5, 0.5, 0.5)
Colours.WindowBg = Colour4.new(0.06, 0.06, 0.06, 0.06)
Colours.ChildBg = Colour4.new(0.0, 0.0, 0.0, 1)
...
Colours.TitleBgActive = Colour4.new(0.16, 0.29, 0.48)
Colours.TitleBgCollapsed = Colour4.new(0.0, 0.0, 0.0, 0.49)
Colours.MenuBarBg = Colour4.new(0.14, 0.14, 0.14)
Colours.ScrollbarBg = Colour4.new(0.02, 0.02, 0.02, 0.47)
Colours.ScrollbarGrab = Colour4.new(0.31, 0.31, 0.31)
Colours.ScrollbarGrabHovered = Colour4.new(0.41, 0.41, 0.41)
Colours.ScrollbarGrabActive = Colour4.new(0.51, 0.51, 0.51)
Colours.CheckMark = Colour4.new(0.26, 0.59, 0.98)
Colours.SliderGrab = Colour4.new(0.24, 0.52, 0.88)
Colours.SliderGrabActive = Colour4.new(0.26, 0.59, 0.98)
Colours.Button = Colour4.new(0.26, 0.59, 0.98, 0.6)
Colours.ButtonHovered = Colour4.new(0.26, 0.59, 0.98)
Colours.ButtonActive = Colour4.new(0.06, 0.53, 0.98)
Colours.Header = Colour4.new(0.26, 0.59, 0.98, 0.69)
Colours.HeaderHovered = Colour4.new(0.26, 0.59, 0.98, 0.2)
Colours.HeaderActive = Colour4.new(0.26, 0.59, 0.98)
Colours.Separator = Colour4.new(0.43, 0.43, 0.50, 0.5)
Colours.SeparatorHovered = Colour4.new(0.1, 0.4, 0.75, 0.22)
Colours.SeparatorActive = Colour4.new(0.1, 0.4, 0.75)
...
Colours.Tab = Colour4.new(0.18, 0.35, 0.58, 0.137)
Colours.TabHovered = Colour4.new(0.26, 0.59, 0.98, 0.2)
Colours.TabActive = Colour4.new(0.2, 0.41, 0.68)
Colours.TabUnfocused = Colour4.new(0.068, 0.102, 0.148, 0.027)
Colours.TabUnfocusedActive = Colour4.new(0.136, 0.262, 0.424)
Colours.PlotLines = Colour4.new(0.61, 0.61, 0.61)
Colours.PlotLinesHovered = Colour4.new(1.0, 0.43, 0.35)
Colours.PlotHistogram = Colour4.new(0.9, 0.7, 0.0)
Colours.PlotHistogramHovered = Colour4.new(1.0, 0.6, 0.0)
Colours.TableHeaderBg = Colour4.new(0.19, 0.19, 0.2)
Colours.TableBorderStrong = Colour4.new(0.31, 0.31, 0.35)
...
Colours.NavHighlight = Colour4.new(0.26, 0.59, 0.98)
...
local ButtonStyles = {
	Title = {
		[1] = Colours.TitleBg,
		[2] = Colours.TitleBgActive,
		[4] = Colours.TitleBgCollapsed,
	},
	TitleButton = {
